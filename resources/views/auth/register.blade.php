                        ...
                        <div class="col-md-10">
                           <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                              <div class="card-body">
                                 ...
                                 <p class="text-center">Let Rasul Consulting LLC streamline the process.</p>
    ...
    <p class="mt-3 text-center">
        Already have an Account <a href="{{ route('login') }}" class="text-underline">Sign In</a>
                     ...
                     <div class="sign-bg sign-bg-right">
                         <img src="/img/rc-symbol.png" style="position: fixed; right:-100px;opacity: .1;transform: rotate(-45deg);" width="300" alt="">
                     </div>
                  </div>
               </div>
            </section>
