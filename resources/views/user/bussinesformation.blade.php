<x-app-layout>
        ...
        <div class="card shadow border-0 mb-7" id="eintabsection">
            <div class="content">
                <div class="py-4 px-3 px-md-4">
                    ...
                    <form id="llcForm" class="row g-3 formsubmission needs-validation" novalidate
                                    ...
                                    <div class="media-body row">
                                        ...
                                        <div class="col-lg-6">
                                            <label for="businessname" class="mid">Business Name <span
                                                ...
                                                <small>(Please enter the name of your business if you are applying for a
                                                    new entity)</small>
                                            </label>
                                            <input type="text" id="businessname" class="form-control"
                                                name="businessname" required placeholder="Enter Business Name">
                                        </div>
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-3">
                                            <label for="address" class="mid">Address <span
                                                    style="color:red">*</span></label>
                                            <input type="text" id="address" class="form-control" name="address" required
                                                placeholder="XX N Sheridan Avenue">
                                        </div>
                                        <div class="col-lg-3">
                                            <label for="addresscity" class="mid">City <span
                                                    style="color:red">*</span></label>
                                            <input type="text" id="addresscity" class="form-control" name="addresscity"
                                                required placeholder="NY">
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="addressstate" class="mid">State <span
                                                    style="color:red">*</span></label>
                                        ...
                                        <div class="col-lg-2">
                                            <label for="addresszipcode" class="mid">Zip Code <span
                                                    style="color:red">*</span></label>
                                            <input type="text" id="addresszipcode" class="form-control"
                                                name="addresszipcode" required placeholder="98765">
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="addresscounty" class="mid">County <span
                                                    style="color:red">*</span></label>
                                            <input type="text" id="addresscounty" class="form-control"
                                                name="addresscounty" required placeholder="Houston">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="media-body row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <select id="formacorporation" class="form-control" name="formacorporation"
                                                required>
                                        ...
                                        <div class="col-lg-4">
                                            <label for="stateof" class="mid">In the State of <span
                                                    style="color:red">*</span></label>
                                            <select name="stateof" id="stateof" class="form-control" required
                                                placeholder="State">
                                                <option value="" disabled selected>Select a state</option>
                                                <option value="AL">Alabama</option>
                                                <option value="AK">Alaska</option>
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col-lg-4">
                                            <label for="qtyshares" class="mid">Qty of Shares <span
                                                    style="color:red">*</span></label>
                                            <input type="text" id="qtyshares" class="form-control" name="qtyshares"
                                                placeholder="Qty of Shares" required>
                                        </div>
                                        <div class="col-lg-4">
                                            <label for="noparvalue" class="mid">No Par Value</label>
                                            <input type="text" id="noparvalue" class="form-control" name="noparvalue"
                                                placeholder="No Par Value">
                                        </div>
                                        <div class="col-lg-4">
                                            <label for="parvalue" class="mid">Par Value</label>
                                            <input type="text" id="parvalue" class="form-control" name="parvalue"
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" id="briefdescription" class="form-control"
                                                name="briefdescription" placeholder="Enter Brief Description" required>
                                        </div>
                                        <div class="col-lg-12">
                                            <label for="principalbusiness" class="mid">Principal Business
                                                Address <span style="color:red">*</span></label>
                                            <input type="text" id="principalbusiness" class="form-control"
                                                name="principalbusiness" placeholder="Enter Principal Business Address"
                                                required>
                                        </div>
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-3">
                                            <label for="businesscounty" class="mid">State <span
                                                    style="color:red">*</span></label>
                                            <select id="businesscounty" class="form-control" name="businesscounty"
                                                required>
                                                <option value="" disabled selected>Select a state</option>
                                                <option value="AL">Alabama</option>
                                                <option value="AK">Alaska</option>
                                        ...
                                        <div class="col-lg-3">
                                            <label for="busineszip" class="mid">Zip Code <span
                                                    style="color:red">*</span></label>
                                            <input type="text" id="busineszip" class="form-control" name="busineszip"
                                                placeholder="Enter Zip Code" required>
                                        </div>
                                        <div class="col-lg-3">
                                            <label for="bcounty" class="mid">County <span
                                                    style="color:red">*</span></label>
                                            <input type="text" id="bcounty" class="form-control" name="bcounty"
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                            ...
                                            <div class="radiobox">
                                                <label>
                                                    <input type="radio" id="regagentYes" name="regagent"
                                                        value="RcActAgent" class="radio  ">
                                                    RC to act as Resident Agent (Additional fees
                                        ...
                                        <div class="row agentdetils" style="display: none;">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <input type="text" id="agentcity" class="form-control" name="agentcity"
                                                    placeholder="Enter Agent City">
                                            </div>
                                            <div class="col-lg-3">
                                                <label for="agentstate" class="mid">State </label>
                                                <select id="agentstate" class="form-control" name="agentstate">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <input type="text" id="agentzip" class="form-control" name="agentzip"
                                    ...
                                    <div class="media-body row">
                                        <div class="col-lg-12 my-5">
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <p>Name</p>
                                                    <input type="text" id="shareholdername1" class="form-control"
                                                        name="shareholdername1" placeholder="Enter Name">
                                                </div>
                                                <div class="col-4">
                                                    <p>EIN/ITIN/SS#</p>
                                                    <input type="text" id="shareholderss1" class="form-control"
                                                        name="shareholderss1" placeholder="Enter EIN/ITIN/SS#">
                                                </div>
                                                <div class="col-3">
                                                    <p>Title</p>
                                                    <input type="text" id="shareholdertitle1" class="form-control"
                                                        name="shareholdertitle1" placeholder="Enter Title">
                                                </div>
                                                <div class="col-3">
                                                    <p>Address</p>
                                                    <input type="text" id="shareholderaddress1" class="form-control"
                                                        name="shareholderaddress1" placeholder="Enter Address">
                                                </div>
                                                <div class="col-3">
                                                    <p>City</p>
                                                    <input type="text" id="shareholder1addresscity" class="form-control"
                                                        name="shareholder1addresscity" required placeholder="NY">
                                                </div>
                                                <div class="col-2">
                                                    <p>State</p>
                                                    <select id="shareholder1addressstate" class="form-control"
                                                        name="shareholder1addressstate" required="">
                                                        <option value="" disabled="" selected="">Select a state</option>
                                                        <option value="AL">Alabama</option>
                                                        <option value="AK">Alaska</option>
                                                        <option value="AZ">Arizona</option>
                                                ...
                                                <div class="col-2">
                                                    <p>Zip Code </p>
                                                    <input type="text" id="shareholder1addresszipcode"
                                                        class="form-control" name="shareholder1addresszipcode" required
                                                        placeholder="98765">
                                                </div>
                                                <div class="col-2">
                                                    <p>County</p>
                                                    <input type="text" id="shareholder1addresscounty"
                                                        class="form-control" name="shareholder1addresscounty" required
                                                        placeholder="Houston">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 my-5">
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <p>Name</p>
                                                    <input type="text" id="shareholdername2" class="form-control"
                                                        name="shareholdername2" placeholder="Enter Name">
                                                </div>
                                                <div class="col-3">
                                                    <p>EIN/ITIN/SS#</p>
                                                    <input type="text" id="shareholderss2" class="form-control"
                                                        name="shareholderss2" placeholder="Enter EIN/ITIN/SS#">
                                                </div>
                                                <div class="col-3">
                                                    <p>Title</p>
                                                    <input type="text" id="shareholdertitle2" class="form-control"
                                                        name="shareholdertitle2" placeholder="Enter Title">
                                                </div>
                                                <div class="col-lg-4">
                                                    <p>Address</p>
                                                    <input type="text" id="shareholderaddress2" class="form-control"
                                                        name="shareholderaddress2" placeholder="Enter Address">
                                                </div>
                                                <div class="col-lg-3">
                                                    <p>City</p>
                                                    <input type="text" id="shareholder2addresscity" class="form-control"
                                                        name="shareholder2addresscity" required placeholder="NY">
                                                </div>
                                                <div class="col-lg-2">
                                                    <p>State</p>
                                                    <select id="shareholder2addressstate" class="form-control"
                                                        name="shareholder2addressstate" required="">
                                                        <option value="" disabled="" selected="">Select a state</option>
                                                        <option value="AL">Alabama</option>
                                                        <option value="AK">Alaska</option>
                                                        <option value="AZ">Arizona</option>
                                                ...
                                                <div class="col-lg-2">
                                                    <p>Zip Code</p>
                                                    <input type="text" id="shareholder2addresszipcode"
                                                        class="form-control" name="shareholder2addresszipcode" required
                                                        placeholder="98765">
                                                </div>
                                                <div class="col-lg-2">
                                                    <p>County</p>
                                                    <input type="text" id="shareholder2addresscounty"
                                                        class="form-control" name="shareholder2addresscounty" required
                                                        placeholder="Houston">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 my-5">
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <p>Name</p>
                                                    <input type="text" id="shareholdername3" class="form-control"
                                                        name="shareholdername3" placeholder="Enter Name">
                                                </div>
                                                <div class="col-3">
                                                    <p>EIN/ITIN/SS#</p>
                                                    <input type="text" id="shareholderss3" class="form-control"
                                                        name="shareholderss3" placeholder="Enter EIN/ITIN/SS#">
                                                </div>
                                                <div class="col-3">
                                                    <p>Title</p>
                                                    <input type="text" id="shareholdertitle3" class="form-control"
                                                        name="shareholdertitle3" placeholder="Enter Title">
                                                </div>
                                                <div class="col-lg-4">
                                                    <p>Address</p>
                                                    <input type="text" id="shareholderaddress3" class="form-control"
                                                        name="shareholderaddress3" placeholder="Enter Address">
                                                </div>
                                                <div class="col-lg-3">
                                                    <p>City</p>
                                                    <input type="text" id="shareholder3addresscity" class="form-control"
                                                        name="shareholder3addresscity" required placeholder="NY">
                                                </div>
                                                <div class="col-lg-2">
                                                    <p>State</p>
                                                    <select id="shareholder3addressstate" class="form-control"
                                                        name="shareholder3addressstate" required="">
                                                        <option value="" disabled="" selected="">Select a state</option>
                                                        <option value="AL">Alabama</option>
                                                        <option value="AK">Alaska</option>
                                                        <option value="AZ">Arizona</option>
                                                ...
                                                <div class="col-lg-2">
                                                    <p>Zip Code</p>
                                                    <input type="text" id="shareholder3addresszipcode"
                                                        class="form-control" name="shareholder3addresszipcode" required
                                                        placeholder="98765">
                                                </div>
                                                <div class="col-lg-2">
                                                    <p>County</p>
                                                    <input type="text" id="shareholder3addresscounty"
                                                        class="form-control" name="shareholder3addresscounty" required
                                                        placeholder="Houston">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 my-5">
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <p>Name</p>
                                                    <input type="text" id="shareholdername4" class="form-control"
                                                        name="shareholdername4" placeholder="Enter Name">
                                                </div>
                                                <div class="col-3">
                                                    <p>EIN/ITIN/SS#</p>
                                                    <input type="text" id="shareholderss4" class="form-control"
                                                        name="shareholderss4" placeholder="Enter EIN/ITIN/SS#">
                                                </div>
                                                <div class="col-3">
                                                    <p>Title</p>
                                                    <input type="text" id="shareholdertitle4" class="form-control"
                                                        name="shareholdertitle4" placeholder="Enter Title">
                                                </div>
                                                <div class="col-lg-4">
                                                    <p>Address</p>
                                                    <input type="text" id="shareholderaddress4" class="form-control"
                                                        name="shareholderaddress4" placeholder="Enter Address">
                                                </div>
                                                <div class="col-lg-3">
                                                    <p>City</p>
                                                    <input type="text" id="shareholder4addresscity" class="form-control"
                                                        name="shareholder4addresscity" required placeholder="NY">
                                                </div>
                                                <div class="col-lg-2">
                                                    <p>State</p>
                                                    <select id="shareholder4addressstate" class="form-control"
                                                        name="shareholder4addressstate" required="">
                                                        <option value="" disabled="" selected="">Select a state</option>
                                                        <option value="AL">Alabama</option>
                                                        <option value="AK">Alaska</option>
                                                        <option value="AZ">Arizona</option>
                                                ...
                                                <div class="col-lg-2">
                                                    <p>Zip Code</p>
                                                    <input type="text" id="shareholder4addresszipcode"
                                                        class="form-control" name="shareholder4addresszipcode" required
                                                        placeholder="98765">
                                                </div>
                                                <div class="col-lg-2">
                                                    <p>County</p>
                                                    <input type="text" id="shareholder4addresscounty"
                                                        class="form-control" name="shareholder4addresscounty" required
                                                        placeholder="Houston">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12 col-xl-12 mb-3 mb-md-4">
                            <div class="card h-100 mt-5 thisisllc" style="display: none;">
                                ...
                                <div class="card-body">
                                    <div class="media-body row">
                                        <div class="col-lg-3">
                                            <label class="form-check-label"><input type="radio" id="ifthisllc"
                                                    name="ifthisllc" value="Member Managed" class="radio  ">
                                                Member Managed</label>
                                        </div>
                                        <div class="col-lg-3">
                                            <label class="form-check-label"><input type="radio" id="ifthisllc"
                                                    name="ifthisllc" value="Manager Managed" class="radio  ">
                                                Manager Managed</label>
                                        </div>
                                        <div class="col-lg-3">
                                            <label class="form-check-label"><input type="radio" id="ifthisllc"
                                                    name="ifthisllc" value="Single Member" class="radio  ">
                                                Single Member</label>
                                        </div>
                                        <div class="col-lg-3">
                                            <label class="form-check-label"><input type="radio" id="ifthisllc"
                                                    name="ifthisllc" value="Multi Member" class="radio  ">
                                                Multi Member</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="media-body row" id="ordersummary">
                                        <div class="col-lg-2" style="display: none;">
                                            <label class="form-check-label"><input type="checkbox" id="plaincopy"
                                                    name="plaincopy" class="radio  ">
                                                Plain copy ($5.00)</label>
                                        </div>
                                        <div class="col-lg-5">
                                            <label class="form-check-label"><input type="checkbox" id="certifiedcopy"
                                                    name="certifiedcopy" class="radio  ">
                                        ...
                                        <div class="col-lg-12 pt-5 pb-5">
                                            <div class="alert alert-primary mt-5 d-none">
                                                <h4>You'll Pay: <span id="totalpricing" name="totalpricing"></span></h4>
                                                <div class="d-none">
                                                    <input type="text" id="service" name="service"
                                                        value="Business Formation" readonly>
                                                    <input type="text" id="authpricing" name="authpricing" readonly>
                                                </div>
                                            </div>
                                            <table cellpadding="5" cellspacing="0" width="100%"
                                                class="border mt-5 table pricingtable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="mb-3"><span id="statefeeprice">$0.00</span></p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <p class="mb-3"><span id="expeditedprice">$0.00</span></p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <p class="mb-3"><span id="eintaxidprice">$0.00</span></p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <p class="mb-3">RC Resident Agent Fee (per year):
                                                            </p>
                                                        </td>
                                                        <td>
                                                            <p class="mb-3"><span id="pfresidentfee">$0.00</span></p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <p class="mb-3"><span id="scorpelectionprice">$0.00</span>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="mb-3"><span id="plaincopyprice">$0.00</span></p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <p class="mb-3"><span id="certifiedprice">$0.00</span></p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p class="mb-3">Pay with Credit/Debit Card (a non-refundable
                                                                portal processing fee applies)
                                                            </p>
                                                        </td>
                                                        <td>
                                                            <p class="mb-3"><span id="certificateexistenceprice">3.5%
                                                                    plus 10c</span>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <h2 class="mb-3"><span id="totalpricing2"></span></h2>
                                                        </th>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="col-12"><small class="mt-5 text-left d-block">Important Note: If any
                                                incorrect information is provided during the application process, you
                                                will need to restart and resubmit the entire application. It is
                                                essential to review all details carefully before submission to avoid any
                                        ...
                                        <div class="col-lg-12 d-flex align-items-center">
                                            ...
                                            <label for="terms">I have read the <a
                                                    ...
                                                    services</a> and <a href="https://rasulcllc.com/privacy-policy/"
                        ...
                        <div class="col-md-12 mt-3 p-5"><small style="font-size:13px">Disclaimer: Please note that while we aim to offer accurate information, this sample application for forming a Limited
                                ...
                                referring to the official guidelines provided by the relevant state or legal authorities
                                for accurate and personalized assistance with your LLC formation process.</small></div>
                    </form>
                </div>
            </div>
            <div class="formpreview column col-12 d-none">
                <h4>Pleaese Review Your Business Entity Formation Application</h4>
                <iframe class="pdf-preview" id="pdfPreviewllc" src="/img/bpf.pdf" type="application/pdf" width="100%"
                    height="600">
                </iframe>
            </div>
        </div>
    ...
    <script src="/js/llctoggle.js"></script>
